...
export default [
  ...
  // PermissionSet override - adds decomposition discriminant for handler routing
  {
    ...
    decomposition: 'containedDecomposed',
  },

  // PermissionSet children - for decomposed PermissionSet handling (Beta & Beta2)
  // CustomPermission is NOT registered here (suffix collision with standalone type).
  // It is handled via path-context override in TypeHandlerFactory.resolveHandler().
  {
  ...
  },
  {
    ...
    xmlName: 'CustomMetadataTypeAccess',
  },
  {
  ...
  },
  {
    ...
    xmlName: 'ExternalCredentialPrincipalAccess',
  },
  {
    ...
    xmlName: 'ExternalDataSourceAccess',
  },
  {
