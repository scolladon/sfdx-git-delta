  ...
  [
    ...
    [
      ...
      [
        ...
        'AssignmentRule',
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<AssignmentRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}<assignmentRule>${EOL}<fullName>AccountRule</fullName>${EOL}</assignmentRule>${EOL}</AssignmentRules>`,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<AssignmentRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}</AssignmentRules>`,
      ],
      [
        'autoResponseRules',
        ...
        new Set(['Account.AccountRule']),
        'AutoResponseRule',
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<AutoResponseRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}<autoResponseRule>${EOL}<fullName>AccountRule</fullName>${EOL}</autoResponseRule>${EOL}</AutoResponseRules>`,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<AutoResponseRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}</AutoResponseRules>`,
      ],
      [
        'escalationRules',
        ...
        new Set(['Account.AccountRule']),
        'EscalationRule',
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<EscalationRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}<escalationRule>${EOL}<fullName>AccountRule</fullName>${EOL}</escalationRule>${EOL}</EscalationRules>`,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<EscalationRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}</EscalationRules>`,
      ],
      [
        'matchingRules',
        ...
        new Set(['Account.AccountRule']),
        'MatchingRule',
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<MatchingRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}<matchingRules>${EOL}<fullName>AccountRule</fullName>${EOL}</matchingRules>${EOL}</MatchingRules>`,
        `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${EOL}<MatchingRules xmlns="http://soap.sforce.com/2006/04/metadata">${EOL}</MatchingRules>`,
      ],
    ],
  ],
  [
